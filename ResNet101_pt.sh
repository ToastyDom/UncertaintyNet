...
#SBATCH --job-name=RN101_pt # name of the job
...
python3 main.py -s optim -m resnet101 -d ham -e 60 -b 64 -f False -p True -g "True" -t 'Optimizing ResNet101 pretrained on Ham'
